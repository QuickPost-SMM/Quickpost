...
import { Home, Menu, User, DollarSign, HelpCircle } from 'lucide-react';
...
export default function AdminLayout({ title, children }) {
    ...
    const navItems = [
        ...
        { name: 'Create Admin', href: '/admin/create', icon: User },
        { name: 'Manage Subscriptions', href: '/admin/subscriptions', icon: DollarSign },
        { name: 'Manage Support Tickets', href: '/admin/support', icon: HelpCircle },
    ];
